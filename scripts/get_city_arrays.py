...
def get_city_arrays(tif_path, borders_path, city, country_path):
    ...
    country_df = df.loc[df['name_conve'] == city]
    # Mask
...
get_city_arrays(snakemake.input[0], snakemake.input[1], snakemake.wildcards[0], snakemake.output[0])
