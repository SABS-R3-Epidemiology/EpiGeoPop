...
def get_country_arrays(tif_path, borders_path, country, country_path):
...
get_country_arrays(snakemake.input[0], snakemake.input[1], snakemake.wildcards[0], snakemake.output[0])
